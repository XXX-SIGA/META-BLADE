...
USN="Mozilla/5.0 (Linux; Android 7.0; SM-G925F Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/65.0.3325.109 Mobile Safari/537.36 Instagram 37.0.0.21.97 Android (24/7.0; 560dpi; 1440x2560; samsung; SM-G925F; zerolte; samsungexynos7420; uk_UA; 98288242)"
...
def User_Agent():
	dpi_phone = [
		'133','320','515','160','640','240','120','408',
		'800','480','225','768','216','1024','540','440','300']
	model_phone = [
		...
		'samsung','OnePlus']
	pxl_phone = [
		'623x1280','700x1245','800x1280','1080x2224','1080x2177',
		'1080x2340','1320x2400','1242x2688','1080x2058','720x1458']
	i_version = [
		'114.0.0.20.2','114.0.0.38.120','244.1.0.19.110',
		'114.0.0.20.70','114.0.0.28.120','240.2.0.18.107',
		'114.0.0.0.24','114.0.0.0.41','141.0.0.32.118']
	User_Agent = f'Instagram '+random.choice(i_version)+' Android (30/3.0; '+random.choice(dpi_phone)+'dpi; '+random.choice(pxl_phone)+'; huawei/google; '+random.choice(model_phone)+'; angler; angler; en_US)'
	return User_Agent

def user_agent():
	resolutions = ['720x1280', '320x480', '480x800', '1024x768', '1280x720', '768x1024', '480x320','1080x2058','1080x2224','1080x2177','720x1458']
	versions = ['GT-N7000', 'SM-N9000', 'GT-I9220', 'GT-I9100','SM-N950U','STK-LX3','2201117TY','SM-M426B']
	dpis = ['120', '160', '320', '240','480','440','300']
...
def key():
	...
	try:ses = requests.Session();asu = ses.get("https://app.cryptolens.io/api/key/Activate?token===&ProductId=16774&Key=%s&Sign=True"%(key)).json()['licenseKey']['key'];open("data/lisensi.txt","w").write(key);prints(Panel(f"{P2}selamat lisensi kamu aktif, tolong gunakan tools ini dengan bijak",width=80,padding=(0,2),style=f"{color_table}"));time.sleep(4);login_kamu()
		...
		os.system("xdg-open https://wa.me/+16143244921?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram")
		time.sleep(2);exit()
...
def key():
	...
	if key in ["open","Open","OPEN"]:print(" wait.. anda akan diarahkan ke WhatsApp");os.system("xdg-open https://wa.me/+16143244921?text=assalamualaikum+bang+mau+beli+lisensi+crack+Instagram");exit()
